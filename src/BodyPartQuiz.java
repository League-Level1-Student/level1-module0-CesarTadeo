...
public class BodyPartQuiz {
    ...
    private void startQuiz() {
   	 ...
   	 String guess = JOptionPane.showInputDialog("who is this? (first name is only needed)");
   	 ...
   	 String guess2 = JOptionPane.showInputDialog("who is this? (first name is only needed)");
   	 ...
   	 String guess3 = JOptionPane.showInputDialog("who is this? (first name is only needed)");
   	 ...
   	 String guess4 = JOptionPane.showInputDialog("who is this? (first name is only needed)");
