...
public class DrumKit implements MouseListener {
	...
	private void getGoing() throws MalformedURLException {
 	...
 	// set its default close operation to JFrame.EXIT_ON_CLOSE
  	  ...
  	  drumWindow.setPreferredSize(new Dimension(500, 500));
  	  ...
  	  String drumImageString1 = "drum.png";
  	  String drumImageString2 = "hihat.png";
  	  // 9. Edit the next line to use your String variable
 	drumLabelWithImage = createLabelImage(drumImageString1);
	...
	System.out.println("mouse clicked");
  	 ...
  	 playSound("488466__trvth__snare1drum.wav");    
  	 }
  	 else if(drumClicked == drumLabelWithImage2){
  	 playSound("25678__walter-odington__avalanche-hat.wav");    
  	 }
